...
type EngineClient interface {
	...
	NewPayloadV4(ctx context.Context, params *engine.ExecutableData, versionedHashes []common.Hash, beaconRoot, requestHash common.Hash) (*engine.PayloadStatusV1, error)
