...
type Validator struct {
	...
	PrevConsAddrExpiry time.Time `protobuf:"bytes,13,opt,name=prev_cons_addr_expiry,json=prevConsAddrExpiry,proto3,stdtime" json:"prev_cons_addr_expiry"`
}
...
func (m *Validator) GetKeyType() string {
	if m != nil {
		return m.KeyType
	}
	return ""
...
func (m *Validator) GetPrevPubkey() []byte {
	if m != nil {
		return m.PrevPubkey
	}
	return nil
...
func (m *Validator) GetPrevKeyType() string {
	if m != nil {
		return m.PrevKeyType
	}
	return ""
}

func (m *Validator) GetRotationApplyHeight() int64 {
	if m != nil {
		return m.RotationApplyHeight
	}
	return 0
}

func (m *Validator) GetPrevConsAddrExpiry() time.Time {
	if m != nil {
		return m.PrevConsAddrExpiry
	}
	return time.Time{}
}
...
var fileDescriptor_3aad17b4b53f2480 = []byte{
	...
	,
}
...
func (m *Validator) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	n1, err1 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.PrevConsAddrExpiry, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.PrevConsAddrExpiry):])
	if err1 != nil {
		return 0, err1
	}
	i -= n1
	...
	i--
	dAtA[i] = 0x6a
	if m.RotationApplyHeight != 0 {
		i = encodeVarintLocking(dAtA, i, uint64(m.RotationApplyHeight))
		i--
		dAtA[i] = 0x60
	}
	if len(m.PrevKeyType) > 0 {
		i -= len(m.PrevKeyType)
		copy(dAtA[i:], m.PrevKeyType)
		i = encodeVarintLocking(dAtA, i, uint64(len(m.PrevKeyType)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.PrevPubkey) > 0 {
		i -= len(m.PrevPubkey)
		copy(dAtA[i:], m.PrevPubkey)
		i = encodeVarintLocking(dAtA, i, uint64(len(m.PrevPubkey)))
		i--
		dAtA[i] = 0x52
	}
	if len(m.KeyType) > 0 {
		...
		i = encodeVarintLocking(dAtA, i, uint64(len(m.KeyType)))
		i--
		dAtA[i] = 0x4a
	}
	...
	i -= n2
	i = encodeVarintLocking(dAtA, i, uint64(n2))
	i--
	dAtA[i] = 0x42
	{
...
func (m *Validator) Size() (n int) {
	...
	if m.RotationApplyHeight != 0 {
		n += 1 + sovLocking(uint64(m.RotationApplyHeight))
	}
	l = github_com_cosmos_gogoproto_types.SizeOfStdTime(m.PrevConsAddrExpiry)
	n += 1 + l + sovLocking(uint64(l))
	return n
}
...
func (m *Validator) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevPubkey", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrevPubkey = append(m.PrevPubkey[:0], dAtA[iNdEx:postIndex]...)
			if m.PrevPubkey == nil {
				m.PrevPubkey = []byte{}
			}
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevKeyType", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrevKeyType = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RotationApplyHeight", wireType)
			}
			m.RotationApplyHeight = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLocking
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RotationApplyHeight |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevConsAddrExpiry", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_cosmos_gogoproto_types.StdTimeUnmarshal(&m.PrevConsAddrExpiry, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
