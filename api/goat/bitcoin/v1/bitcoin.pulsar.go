...
var (
	...
	fd_BlockHeader_raw    protoreflect.FieldDescriptor
)

func init() {
	file_goat_bitcoin_v1_bitcoin_proto_init()
	md_BlockHeader = File_goat_bitcoin_v1_bitcoin_proto.Messages().ByName("BlockHeader")
	fd_BlockHeader_height = md_BlockHeader.Fields().ByName("height")
	fd_BlockHeader_raw = md_BlockHeader.Fields().ByName("raw")
}
...
func (x *fastReflection_BlockHeader) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "goat.bitcoin.v1.BlockHeader.height":
		return x.Height != uint64(0)
	case "goat.bitcoin.v1.BlockHeader.raw":
		return len(x.Raw) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.bitcoin.v1.BlockHeader"))
		}
		panic(fmt.Errorf("message goat.bitcoin.v1.BlockHeader does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_BlockHeader) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message goat.bitcoin.v1.BlockHeader does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_BlockHeader) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "goat.bitcoin.v1.BlockHeader.height":
		panic(fmt.Errorf("field height of message goat.bitcoin.v1.BlockHeader is not mutable"))
	case "goat.bitcoin.v1.BlockHeader.raw":
		panic(fmt.Errorf("field raw of message goat.bitcoin.v1.BlockHeader is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.bitcoin.v1.BlockHeader"))
		}
...
func (x *fastReflection_BlockHeader) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in goat.bitcoin.v1.BlockHeader", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *BlockHeader) GetRaw() []byte {
	if x != nil {
		return x.Raw
	}
	return nil
...
var file_goat_bitcoin_v1_bitcoin_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x69, 0x70, 0x74, 0x22, 0x37, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65,
	...
	,
...
var file_goat_bitcoin_v1_bitcoin_proto_goTypes = []interface{}{
	...
	(*BlockHeader)(nil),       // 4: goat.bitcoin.v1.BlockHeader
