...
func (x *fastReflection_GenesisState) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.Pubkeys) != 0 {
		value := protoreflect.ValueOfList(&_GenesisState_4_list{list: &x.Pubkeys})
...
func (x *fastReflection_GenesisState) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "goat.relayer.v1.GenesisState.pubkeys":
		...
		listValue := &_GenesisState_4_list{list: &x.Pubkeys}
		return protoreflect.ValueOfList(listValue)
	default:
...
func (x *fastReflection_GenesisState) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "goat.relayer.v1.GenesisState.pubkeys":
		...
		value := &_GenesisState_4_list{list: &x.Pubkeys}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.relayer.v1.GenesisState"))
...
type GenesisState struct {
	...
	Pubkeys []*PublicKey `protobuf:"bytes,4,rep,name=pubkeys,proto3" json:"pubkeys,omitempty"`
}
...
var file_goat_relayer_v1_genesis_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xef, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x6e, 0x65, 0x73,
	...
	,
	...
	0x07, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x73, 0x42, 0xbc, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d,
...
var file_goat_relayer_v1_genesis_proto_goTypes = []interface{}{
	...
	(*Relayer)(nil),      // 2: goat.relayer.v1.Relayer
...
var file_goat_relayer_v1_genesis_proto_depIdxs = []int32{
	...
	2, // 1: goat.relayer.v1.GenesisState.relayer:type_name -> goat.relayer.v1.Relayer
	3, // 2: goat.relayer.v1.GenesisState.voters:type_name -> goat.relayer.v1.Voter
