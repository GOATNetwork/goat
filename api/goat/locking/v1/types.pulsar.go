...
var _ protoreflect.List = (*_Threshold_1_list)(nil)

type _Threshold_1_list struct {
	list *[]*v1beta1.Coin
}

func (x *_Threshold_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Threshold_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_Threshold_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_Threshold_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_Threshold_1_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Threshold_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_Threshold_1_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_Threshold_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_Threshold      protoreflect.MessageDescriptor
	fd_Threshold_list protoreflect.FieldDescriptor
)

func init() {
	file_goat_locking_v1_types_proto_init()
	md_Threshold = File_goat_locking_v1_types_proto.Messages().ByName("Threshold")
	fd_Threshold_list = md_Threshold.Fields().ByName("list")
}

var _ protoreflect.Message = (*fastReflection_Threshold)(nil)

type fastReflection_Threshold Threshold

func (x *Threshold) ProtoReflect() protoreflect.Message {
	return (*fastReflection_Threshold)(x)
}

func (x *Threshold) slowProtoReflect() protoreflect.Message {
	mi := &file_goat_locking_v1_types_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_Threshold_messageType fastReflection_Threshold_messageType
var _ protoreflect.MessageType = fastReflection_Threshold_messageType{}

type fastReflection_Threshold_messageType struct{}

func (x fastReflection_Threshold_messageType) Zero() protoreflect.Message {
	return (*fastReflection_Threshold)(nil)
}
func (x fastReflection_Threshold_messageType) New() protoreflect.Message {
	return new(fastReflection_Threshold)
}
func (x fastReflection_Threshold_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_Threshold
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_Threshold) Descriptor() protoreflect.MessageDescriptor {
	return md_Threshold
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_Threshold) Type() protoreflect.MessageType {
	return _fastReflection_Threshold_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_Threshold) New() protoreflect.Message {
	return new(fastReflection_Threshold)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_Threshold) Interface() protoreflect.ProtoMessage {
	return (*Threshold)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_Threshold) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.List) != 0 {
		value := protoreflect.ValueOfList(&_Threshold_1_list{list: &x.List})
		if !f(fd_Threshold_list, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_Threshold) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "goat.locking.v1.Threshold.list":
		return len(x.List) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.locking.v1.Threshold"))
		}
		panic(fmt.Errorf("message goat.locking.v1.Threshold does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Threshold) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "goat.locking.v1.Threshold.list":
		x.List = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_Threshold) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "goat.locking.v1.Threshold.list":
		if len(x.List) == 0 {
			return protoreflect.ValueOfList(&_Threshold_1_list{})
		}
		listValue := &_Threshold_1_list{list: &x.List}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.locking.v1.Threshold"))
		}
		panic(fmt.Errorf("message goat.locking.v1.Threshold does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Threshold) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "goat.locking.v1.Threshold.list":
		lv := value.List()
		clv := lv.(*_Threshold_1_list)
		x.List = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.locking.v1.Threshold"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Threshold) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "goat.locking.v1.Threshold.list":
		if x.List == nil {
			x.List = []*v1beta1.Coin{}
		}
		value := &_Threshold_1_list{list: &x.List}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.locking.v1.Threshold"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_Threshold) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "goat.locking.v1.Threshold.list":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_Threshold_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: goat.locking.v1.Threshold"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_Threshold) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in goat.locking.v1.Threshold", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_Threshold) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_Threshold) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_Threshold) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_Threshold) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*Threshold)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: Threshold: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: Threshold: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
				...
				x.List = append(x.List, &v1beta1.Coin{})
...
func (*Threshold) Descriptor() ([]byte, []int) {
	return file_goat_locking_v1_types_proto_rawDescGZIP(), []int{6}
}
...
var file_goat_locking_v1_types_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x6a, 0x0a, 0x05, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x77,
	0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x77, 0x65, 0x69,
	0x67, 0x68, 0x74, 0x12, 0x49, 0x0a, 0x09, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64,
	...
	,
	...
	0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x04, 0x67, 0x6f,
	0x61, 0x74, 0x12, 0x3d, 0x0a, 0x03, 0x67, 0x61, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x2b, 0xc8, 0xde, 0x1f, 0x00, 0xda, 0xde, 0x1f, 0x15, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73,
	0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x6d, 0x61, 0x74, 0x68, 0x2e, 0x49, 0x6e, 0x74, 0xd2, 0xb4,
	0x2d, 0x0a, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0x52, 0x03, 0x67, 0x61,
	0x73, 0x22, 0x91, 0x01, 0x0a, 0x06, 0x55, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x72, 0x65, 0x63, 0x69, 0x70, 0x69, 0x65, 0x6e, 0x74,
	0x12, 0x43, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	0x75, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x22, 0x71, 0x0a, 0x09, 0x54, 0x68, 0x72, 0x65, 0x73,
	0x68, 0x6f, 0x6c, 0x64, 0x12, 0x64, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03,
	...
	0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x42, 0xba, 0x01, 0x0a, 0x13, 0x63,
...
var file_goat_locking_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_goat_locking_v1_types_proto_goTypes = []interface{}{
	...
	(*Threshold)(nil),    // 6: goat.locking.v1.Threshold
...
var file_goat_locking_v1_types_proto_depIdxs = []int32{
	...
	7, // 3: goat.locking.v1.Threshold.list:type_name -> cosmos.base.v1beta1.Coin
...
func file_goat_locking_v1_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_goat_locking_v1_types_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
